...
namespace MediSure
{
    public partial class AdminRegistration : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string ins = "INSERT INTO Admin_Reg_Table VALUES(" + reg_id + ", '" + TextBox1.Text + "', '" + TextBox2.Text + "')";
            int i = obj.Fun_Non_Query(ins);

            if (i == 1)
            {
                string inslog = "INSERT INTO Login_Table2  VALUES(" + reg_id + ", '" + TextBox3.Text + "', '" + TextBox4.Text + "', 'admin', 'active')";
